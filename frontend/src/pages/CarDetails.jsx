...
const CarDetails = () => {
  ...
  const handleSubmit = async (e) => {
	...
	// navigate(-1) means redirect the user in previous page
	return car ? (
		<div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-16">
					...
					<div className="space-y-6">
						...
						<div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
							{[
								...
								{ icon: assets.location_icon, text: `${car.location} Seats` },
							].map(({ icon, text }) => (
								<div
									key={text}
          ...
          <button className="w-full bg-primary hover:bg-primary-dull transiton-all py-3 font-medium text-white rounded-xl cursor-pointer">Book Now</button>
