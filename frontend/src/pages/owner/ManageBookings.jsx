...
const ManageBookings = () => {
	...
	return (
		<div className="px-4 pt-10 ms:px-10 w-full">
			<Title
			...
			<div className="max-w-3xl w-full rounded-md overflow-hidden border border-borderColor mt-6">
                ...
                <td className="p-3 max-md:hidden">
                  {booking.pickupDate.split('T')[0]} to {booking.pickupDate.split('T')[0]}
                </td>
                ...
                <td className="p-3">
                  {booking.status === 'pending' ? (
                    <select value={booking.status} className="px-2 py-1.5 mt-1 text-gray-500 border-borderColor rounded-md outline-none">
